...
export const ConfirmationTemplate = ({ domain, token }: IConfirmationTemplateProps) => {
    ...
    <Tailwind>
      <Html>
        <Body className='text-black'>
          ...
          <Text>
            Чтобы подтвердить свой адрес электронной почты, пожалуйста, перейдите по следующей
            ссылке:
          </Text>
